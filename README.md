<!-- vue3 + typescript + vite  项目创建流程 -->


<!-- 安装 node   node -v   若使用pnpm安装，那么版本号必须 16+ -->

<!-- 安装pnpm 是npm衍生品，比npm性能好    命令：npm i -g pnpm     版本号：  pnpm -v  -->

<!-- 安装vite  命令： pnpm create vite -->

<!-- 安装node_modules   命令： npm i -->

<!-- npm init   生成pakage.json文件 -->

<!-- 运行项目   命令： pnpm run dev -->

<!-- 安装eslint  js检查器  命令： npm init @eslint/config     注： vscode自带插件有，无需手动配置安装 -->   

<!-- 安装 Prettier - Code formatter插件   vscode自带插件    规范格式化代码-->

<!-- 安装 stylelint vscode自带插件   规范css规范 -->

<!-- 配置husky  在代码提交到远程仓库之前格式化一下没有格式化的代码  命令： pnpm install -D husky 这个需要配合git一起使用 先git init -->

<!-- 安装 element-plus UI组件库   命令： npm install element-plus --save -->

<!-- 安装element-plus组件代码快捷提示插件 在vscode中自带  Element UI Snippets -->

<!-- 安装 @element-plus/icons-vue图标库    命令：  npm i @element-plus/icons-vue -->

<!-- 更改src文件夹名为@    具体百度 更改文件夹  vite.config.ts 和 tsconfig.json -->

<!-- 配置环境变量  （开发、测试、生产） src目录下  .env.development   .env.production  .env.test -->

<!-- 安装SVG图标   命令： npm install vite-plugin-svg-icons -D -->

<!-- 安装scss或less    命令：  npm install sass --save-dev -->

<!-- 安装配置mock   命令：  npm install vite-plugin-mock@2.9.8 --save-dev -->

<!-- interface  接口数据ts类型设置 -->

<!-- 安装路由   命令：  npm i vue-router -->


<!-- 引入‘vue’飘红  需要tsconfig文件内    修改为： "moduleResolution": "node" -->
